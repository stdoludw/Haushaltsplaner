...
public class INSERT_Produkt_SQL extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute(CONTROLLER_Statments.session.Insert_Produkt.toString(),new MODEL_Produkt(
		...
		session.setAttribute("site",CONTROLLER_Statments.caller.Insert_Produkt.toString());
